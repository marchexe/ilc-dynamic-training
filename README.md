...
An experimental, opt-in online hyperparameter controller is documented in
[docs/training-controller.md](docs/training-controller.md). It is disabled by
default and does not change existing Weaver training behavior.
