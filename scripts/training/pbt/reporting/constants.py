...
# Conditional corroboration figure generated by reporting/report_plots.py.
# The primary PBT presentation figures are generated separately, while the
# retained physics figures also live directly under <run_dir>/plots/.
REPORT_PLOT_NAMES = {
