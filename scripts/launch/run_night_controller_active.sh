...
# overnight A/B experiment on iutgpu01:4-7. Not executed automatically -- run
# it yourself, typically via nohup, e.g.:
#   nohup bash scripts/launch/run_night_controller_active.sh > /tmp/controller_active_night.log 2>&1 &
# or invoke it through scripts/launch/run_night_controller_ab.sh, which
...
CONFIG="configs/experiments/pretrained_pbt_4gpu_night_controller_active.yaml"
SLOTS="iutgpu01:4,iutgpu01:5,iutgpu01:6,iutgpu01:7"
EXPERIMENT_NAME="${1:-pretrained_pbt_4gpu_night_controller_active}"
