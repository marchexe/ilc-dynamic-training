...
# overnight A/B experiment on iutgpu01:0-3. Not executed automatically -- run
# it yourself, typically via nohup, e.g.:
#   nohup bash scripts/launch/run_night_controller_off.sh > /tmp/controller_off_night.log 2>&1 &
...
CONFIG="configs/experiments/pretrained_pbt_4gpu_night_controller_off.yaml"
SLOTS="iutgpu01:0,iutgpu01:1,iutgpu01:2,iutgpu01:3"
EXPERIMENT_NAME="${1:-pretrained_pbt_4gpu_night_controller_off}"
